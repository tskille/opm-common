...
public:
    ...
    template <typename T>
    const std::vector<T>& getInitData(const std::string& name, const std::string& grid_name = "global") const
    {
...
protected:
    ...
    template <typename T>
    const std::vector<T>& ImplgetInitData(const std::string& name, const std::string& grid_name = "global") const
    {
