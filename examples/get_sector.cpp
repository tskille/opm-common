...
int main(int argc, char **argv) {
    ...
    int i2 = std::stoi(argv[argOffset+2]);

    int j1 = std::stoi(argv[argOffset+3]);
    int j2 = std::stoi(argv[argOffset+4]);

    int k1 = std::stoi(argv[argOffset+5]);
    int k2 = std::stoi(argv[argOffset+6]);

    std::string rootn = argv[argOffset];
    rootn = rootn.substr(0,rootn.size()-6);

    std::string egridfile = rootn + ".EGRID";
